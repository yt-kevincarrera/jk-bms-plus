...
no account and no server. [docs/LICENSING.md](docs/LICENSING.md) has the
mechanism and the tool that issues keys.
...
| M7 — licences | Done: device code, Ed25519 keys checked on the phone, 7-day Pro trial, Pro/Workshop/credits tiers, gating. Waiting on the author's key pair (see [docs/LICENSING.md](docs/LICENSING.md)) before a build can accept a key |
