...
class RideAlerts {
  ...
  final double deltaWarn;
  final double deltaClear;
  final double tempWarn;
  final double tempClear;
  final double lowChargeWarn;
  final double lowChargeClear;
  ...
  List<RideAlert> evaluate(
    ...
    final hottest =
        temps.isEmpty ? 0.0 : temps.reduce((a, b) => a > b ? a : b);
